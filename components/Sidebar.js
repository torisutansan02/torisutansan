  ...
  return (
    <div>
      <Disclosure as="nav">
        ...
        <div className="p-1 w-11 h-screen bg-zinc-800 z-20 fixed top-10 -left-96 lg:left-0 lg:w-60  peer-focus:left-0 peer:transition ease-out delay-150 duration-200">
